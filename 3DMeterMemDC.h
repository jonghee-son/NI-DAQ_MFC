#ifndef _3DMETER_MEMDC1_H_
#define _3DMETER_MEMDC1_H_
...
class C3DMeterMemDC : public CDC 
{
private:	
...
public:
	...
	C3DMeterMemDC(CDC* pDC, const CRect* pRect = NULL, bool boolToMemory = TRUE) : CDC()
	{
		ASSERT(pDC != NULL); 
	...
	C3DMeterMemDC* operator->() 
	{
		return this;
	}	

	// Allow usage as a pointer	
	operator C3DMeterMemDC*() 
	{
		return this;
	}
};
